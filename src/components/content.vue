      ...
      el-col(:xs=18, :sm=18, :md=12)
        ...
        el-form(ref="form", :model="form", :rules="rules", label-position="top")
          ...
          template(v-if="isBug")
            ...
            el-form-item(:label="contents.code", prop="code")
              el-input(type="textarea", v-model="form.code", :autosize="{ minRows: 10, maxRows: 50 }")
...
<script>
  ...
  const comment = '<!-- generated by https://doc.vux.li/issue-generator DO NOT REMOVE -->'
  ...
  export default {
    ...
    data () {
      ...
      if (repo === 'vux') {
        queryRepo = 'VUX'
      } else if (repo === 'vux-loader') {
        queryRepo = 'vux-loader'
      }
